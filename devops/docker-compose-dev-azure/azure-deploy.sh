...
resourcename="cardealershipsystemiter1"  # lower case, only
resourcegroup="cardealershipsystemiter1_rg"
...
# git clone https://github.com/apilogicserver/cardealershipsystemiter1.git
# cd cardealershipsystemiter1
...
az group create --name cardealershipsystemiter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group cardealershipsystemiter1_rg --sku S1 --is-linux
az container create --resource-group cardealershipsystemiter1_rg --name cardealershipsystemiter1 --image apilogicserver/cardealershipsystemiter1:latest --dns-name-label cardealershipsystemiter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//cardealershipsystemiter1.westus.azurecontainer.io:5656'
